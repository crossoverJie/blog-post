...
最近分享的一些源码、框架设计的东西。我发现大家热情不是特别高，想想大多数应该还是正儿八经写代码的居多；这次就分享一点接地气和 SpringBoot 使用中的一些小技巧。
...
- 推送到开发环境应该是比较靠谱的方案，但如果想在调试只有日志大法，没有本地 `debug` 的效率高效。
