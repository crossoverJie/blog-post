...
![](https://i.loli.net/2019/05/08/5cd1ba01ebc22.jpg)
...
![](https://i.loli.net/2019/05/08/5cd1ba07908f0.jpg)
...
![](https://i.loli.net/2019/05/08/5cd1ba12a3b62.jpg)

这样会导致大部分数据都在 N1 节点，只有少量的数据在 N2 节点。

为了解决这个问题，一致哈希算法引入了虚拟节点。将每一个节点都进行多次 hash，生成多个节点放置在环上称为虚拟节点:

![](https://i.loli.net/2019/05/08/5cd1ba1490a67.jpg)
